...
pts <- readShapePoints("C:/Users/rkopp/Desktop/R_work/Cost_Distance_R/Decha_Transect_Points/Decha_Transect_Points.shp")
...
sel_jim <- gadm36_ETH_2_sp$NAME_2 == "Jimma"
sel_keffa <- gadm36_ETH_2_sp$NAME_2 == "Keffa"
plot(gadm36_ETH_2_sp[ sel_jim, ], col = "turquoise", add = TRUE)
...
#Generate a plotting function and load in Ethiopian "regional", "woreda, and "Kabelle" shapefiles. The files are loaded with the raster package using the "getdata function.
```{r}
#Plotting function
